...
def calculate_rhythmicity(signal):
    ...
    # We look at the first 'peak' after zero. If it's high, it's rhythmic.
    # Simple heuristic: max value of the second half of the correlation
    return np.max(norm_corr[int(len(norm_corr)*0.1):])
