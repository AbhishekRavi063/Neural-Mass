...
def generate_multitaper_kcomplex_candidates(
    ...
    This is not a full MT-KCD reproduction. It borrows the key idea that
    K-complexes should stand out as short, high-power delta events, then leaves
    the final decision to the classifier.
    """
