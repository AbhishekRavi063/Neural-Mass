...
from neural_mass.detection.kcomplex_window_detector import _THRESHOLDS_GRID as THRESHOLDS_GRID
...
def detect_full_recording(signal, sfreq, model, threshold, chunk_minutes=30.0):
    ...
    at chunk boundaries.
    """
    from neural_mass.detection.kcomplex_window_detector import slow_wave_candidate_windows, extract_window_features
