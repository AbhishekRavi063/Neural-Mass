...
class KComplexDetector:
    ...
    def predict(self, signal: NDArray) -> list[dict]:
        ...
        filtered = bandpass_signal(signal, self.sfreq)
        _, windows, X, _ = build_window_dataset(signal, self.sfreq, [])
    ...
    def score_onset(
        ...
        from neural_mass.event_scoring import score_events_onset
...
class SpindleDetector:
    ...
    def predict(self, signal: NDArray) -> NDArray:
        ...
        from neural_mass.event_detection import spindle_detection
